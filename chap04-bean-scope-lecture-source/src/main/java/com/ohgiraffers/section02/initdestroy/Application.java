...
public class Application {
    public static void main(String[] args) {
        ...
        /* 설명. 주소값이 같은지 확인 */
        System.out.println("cart1과 cart2의 주소값이 같은가? " + (System.identityHashCode(cart1) == System.identityHashCode(cart2)));

        /* 설명. main 메소드 종료 전(application 종료 전)에 의도적으로 container를 소멸(bean들도 소멸)하기 */
